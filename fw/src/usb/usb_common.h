...
#define USB_DT_IFACE_ASSOC 0x0b
...
struct usb_device_descriptor {
    uint8_t bLength {sizeof(usb_device_descriptor)};
...
struct usb_configuration_descriptor {
    uint8_t bLength { sizeof(usb_configuration_descriptor) };
...
struct usb_interface_descriptor {
    uint8_t bLength { sizeof(usb_interface_descriptor) };
...
struct usb_interface_association_descriptor {
    uint8_t bLength { sizeof(usb_interface_association_descriptor) };
    uint8_t bDescriptorType { USB_DT_IFACE_ASSOC };
...
struct usb_endpoint_descriptor {
    uint8_t bLength { sizeof(usb_endpoint_descriptor) };
...
struct usb_endpoint_descriptor_long {
    uint8_t bLength { sizeof(usb_endpoint_descriptor_long) };
    uint8_t bDescriptorType  { USB_DT_ENDPOINT };
    uint8_t bEndpointAddress;
    uint8_t bmAttributes;
    uint16_t wMaxPacketSize;
